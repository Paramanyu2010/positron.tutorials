...
<!-- PG:Condense AI prompt to "Create a scatter plot from wine_tibble with Phenols vs Flavanoids, colored by Color. Include jittered points, a LOESS smooth curve, and label the maximum Flavanoids value as 'Outlier' in magenta. Use blue-to-orange color gradient and classic theme." -->
